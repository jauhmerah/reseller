		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w">
					<div class="col-md-3 col-md-offset-6"><img src="<?php echo Base_url();?>Assets/Login_v10/images/Logo2.png" alt="Nasty" style=width="250" height="150"></div>
