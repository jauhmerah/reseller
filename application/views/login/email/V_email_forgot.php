							...
							<tr>
								<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
									...
									<p style="text-align:center;margin:0;padding:0;">
										<img src="<?php echo Base_url();?>asset/login/Login_v10/images/logo4.png" style="max-width:150px;display:inline-block;">
									</p>
										...
										<tbody>
											...
											<tr align="top">
												<td valign="top" class="bodyContentImage">
													You can change your password again at any time from within your My Account portal at <a href="<?= site_url(); ?>"><?= site_url(); ?></a>.
												</td>
											</tr>
											<tr align="top">
												<td valign="top" class="bodyContentImage">
															...
															<tr>
																<td align="left" width="50" valign="top" mc:edit="footer_sigimage" style="margin:0;padding:0;">
																	<p style="margin-bottom:10px; padding:0;display:block;">
																		<img src="<?php echo base_url('asset/login/img/Nasty IT.jpg');?>" style="max-width:50px;display:inline-block;">
																	</p>
																</td>
